...
- Resolution/Status: OPEN. Evidence mechanism implemented (ST-18.4A corrected commit, 2026-07-13). Adds: (1) private evidence observer with corrected semantics separating raw codec_context_is_hwaccel from actual_hardware_decode_active, (2) _create_hwaccel_with_evidence capturing creation errors, (3) deterministic generator cleanup, (4) provenanc-validated probe with explicit accepted-base and canonical-mode. Tests: 17/17 pass. However, the canonical Hermes H.264 clip (dd9da344...) is NOT available on this workstation — cannot close F-0098 without it. Step 18.4A remains in_progress / blocked on canonical evidence object.
...
- Finding: The canonical benchmark evidence object (examples/hermes-0000-1000.mp4, SHA256 dd9da344..., H.264, 1920x1080, ~600s) is not present on the current workstation. Searched: D:\git\video2pptx\examples\, D:\git\worktrees\*\examples\, common download/video directories. The file is intentionally gitignored and must be obtained separately.
- Symptom/Reproduction: Step 18.4A probe cannot be executed with canonical evidence because the clip file does not exist on this system.
- Impact: F-0098 cannot be closed. Step 18.4A cannot advance past in_progress / blocked. The H.264 HWAccel runtime state remains unobserved. The corrected evidence mechanism and probe tool are ready and tested (17/17 tests pass, probe accepts --canonical-mode and --accepted-base).
- Resolution/Status: OPEN. Copy the canonical clip (hermes-0000-1000.mp4, SHA256 dd9da344...) to D:\git\video2pptx\examples\ and re-run: `python tools/probe_pyav_hwaccel.py --canonical-mode --accepted-base f52e82c55744de077984db3b9bcb2162d4f9d87f`
