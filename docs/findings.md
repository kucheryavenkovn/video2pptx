...
- Resolution/Status: IN_PROGRESS — Phase 19 Steps 19.0–19.4 done (dual-res path + metrics). Golden-mean selection still requires Steps 19.5–19.7 sweep evidence. Default remains native (`analysis_max_side=None`). Plan: docs/plans/phase19-analysis-resolution-golden-mean.md.
- LINKS: M-ANALYSIS-SCALE, M-GOLDEN-MEAN-SWEEP, M-GOLDEN-MEAN-DECISION, M-PHASE19-PLAN, M-FRAME-FEATURES, M-DETECT-SLIDES, V-M-PHASE19-PLAN, V-M-ANALYSIS-SCALE, V-M-DETECT-ANALYSIS-SCALE, F-0103, benchmarks/detect/evidence/bottleneck_decision.md
