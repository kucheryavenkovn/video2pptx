# FILE: src/video_slide_md/gui/settings_app.py
# VERSION: 0.1.0
...
from video_slide_md.gui.app_config import AppConfigModel, save_app_config
...
class AppSettingsDialog(QDialog):
    ...
    def _load_values(self) -> None:
        ...
        self._llm_model_edit.setText(llm.model)
    ...
    def _on_accept(self) -> None:
        llm = self._app_config.llm
        llm.model = self._llm_model_edit.text().strip() or llm.model
