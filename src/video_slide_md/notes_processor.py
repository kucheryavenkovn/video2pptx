# FILE: src/video_slide_md/notes_processor.py
# VERSION: 0.1.0
...
def process_notes(
    ...
    if mode == "llm" and llm_client is not None:
        return _llm_rephrase(raw, seg, llm_client)
...
def _llm_rephrase(text: str, seg: SlideSegment, client) -> str:
    # START_CONTRACT: _llm_rephrase
    #   PURPOSE: Send text to LLM for sentence-level rephrasing
    #   INPUTS: {
    ...
    from video_slide_md.pptx_export import _fmt_time
