# FILE: src/video2pptx/gui/app_config.py
# VERSION: 0.1.0
...
def add_recent_project(path: str, config: AppConfigModel | None = None) -> AppConfigModel:
    # START_CONTRACT: add_recent_project
    #   PURPOSE: Add a project path to recent list (unique, max 10), persist changes
    #   INPUTS: { path: str, config: AppConfigModel | None }
    #   OUTPUTS: AppConfigModel — updated config
    #   SIDE_EFFECTS: persists config if config is None
    #   LINKS: M-GUI-APPCONFIG
    # END_CONTRACT: add_recent_project
