...
#   SCOPE: One function: run_detect_slides() that opens video, detects changes, deduplicates,
#          saves screenshots, slides.json. 2-pass detection. DetectionRunMetrics instrumentation:
#          frames_sampled (Pass 1), pass2_frames_sampled (Pass 2), rss_before/peak/after gauges,
#          RssSampler for peak RSS tracking, representative_frame_bytes evidence.
#   DEPENDS: models, config, video_decode, roi, frame_features, slide_detector, segmenter,
#            dedupe, detection_metrics
